...
<div class="dt-content-wrapper">
        ...
        <div class="profile">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    <button class="btn btn-light btn-sm display-i ft-right" data-toggle="modal" data-target="#depositModal"><?php echo lang('make_deposit') ?></button>
                    <?php } } ?>
                            ...
                            <div class="modal fade display-n" id="confirmationModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <?php echo form_open_multipart(base_url('approveWithdrawal') , array( 'id'=>'confirm-form', 'class' => 'confirm-form', 'data-url'=> base_url() ));?>
                                        <!-- Modal Body -->
    ...
    <!-- /modal -->
    <?php if($role == ROLE_ADMIN || $this->user_model->getPermissions('deposits', 'add', $userId)) {
        $this->view('backend/transactions/admin/deposits/add');
    }?>
    <script src="<?=base_url('/assets/dist/js/trans.js') ?>"></script>
    <script>
                ...
                success: function(res) {
                    ...
                    if(content.success == true)
                    {
                            ...
                            if(content.data.withdrawal_account == null){
                                ...
                                var div13 = '<div class="col-md-6"><a href="<?= base_url() ?>uploads/withdrawal/'+content.data.img+'" target="_blank">Click to view Deposit Slip</a></div>'
                                var divClose = '</div>'

                                if(content.data.status == '0' || content.data.status == '1'){
                                    div.innerHTML += divOpen + div1 + div2 + div3 + div4 + div5 + div6 + div7 + div8 + div9 + div10 + div13 + divClose;
                                } else {
                                    div.innerHTML += divOpen + div1 + div2 + div3 + div4 + div5 + div6 + div7 + div8 + div9 + div10 + div11 + div12 + div13 + divClose;
                                }
                            } else {
                                var divOpen = '<div class="row col-md-12">'
