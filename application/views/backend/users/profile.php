...
$lsocial = set_value('lsocial') == false ? $this->security->xss_clean($userInfo->social) : set_value('lsocial');
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <!-- Form Group -->
                                                                    <div class="form-group">
                                                                        <label for="lsocial">Social Media Link</label>
                                                                        <input type="text" value="<?php echo $lsocial; ?>"
																																				name="lsocial"  class="form-control <?php echo form_error('lsocial') == TRUE ? 'inputTxtError' : ''; ?>" id="lsocial"
                                                                            aria-describedby="lsocial" placeholder="Social media Link">
                                                                        <label class="error" for="fname"><?php echo form_error('lsocial'); ?></label>
                                                                    </div>
                                                                    <!-- /form group -->
                                                                </div>
                                                                <div class="col-md-12">
