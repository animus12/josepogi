            ...
            <div class="dt-login__content-wrapper">
                ...
                <div class="dt-login__content">
                    ...
                    <div class="dt-login__content-inner">
                        ...
                        <h2 class="f-20 text-capitalize" id="registerTitle"><?php echo lang("create_account") ?></h2>
                        <h2 class="f-20 text-capitalize d-none" id="verifyTitle">Verify Your Email</h2>
                        <div class="d-none" id="verifyPage">
                            <h3 class="text-muted">Click the link sent to your email to verify your account</h3>
                            <button type="button" id="resendlink" class="btn btn-info text-uppercase" data-url="<?=base_url('resend-verification-email/')?>">Resend Link</button>
                        </div>
                        ...
                        <?php echo form_open(base_url( 'signup' ), array( 'id' => 'registerForm' ));?>
                          <div class="row">
                            ...
                            <!-- /form group -->
													 ...
													 <!-- Form Group -->
													 <div class="form-group">
                                <label class="sr-only" for="social_l"><?php echo lang("social_media") ?></label>
                                <input type="text" class="form-control" name="social" id="social_l"
                                    aria-describedby="social_l" placeholder="Facebook Profile Link" value="<?=set_value('social')?>">
                                    <label class="error" id="social"></label>
                            </div>
                            <!-- /form group -->
