...
class User extends BaseController
{
    ...
    function profileUpdate($active = "details")
    {
        ...
        $this->form_validation->set_rules('lsocial','Social Media Link','required|max_length[255]', array(
            'required' => lang('this_field_is_required')
        ));
        ...
        else
        {
            ...
            $lsocial = $this->input->post('lsocial', TRUE);
            $mobile = $this->input->post('fullMobile', TRUE);
            $email = strtolower($this->input->post('email', TRUE));
            $userInfo = array('firstName'=>$fname, 'lastName'=>$lname, 'email'=>$email,'social'=> $lsocial ,'mobile'=>$mobile, 'updatedBy'=>$this->vendorId, 'updatedDtm'=>date('Y-m-d H:i:s'));
