...
$route['resend-verification-email'] = "auth/resend_link";
...
$route['approveWithdrawal'] = "transactions/approveWithdrawal";
...
/*********** FILE UPLOAD *******************/
$route['file-upload'] = "transactions/do_upload";
